...
const defaultViewOptions = {
  ...
  intermediateMajorGridlineColor: '#dddddd',
  intermediateMinorGridlineColor: '#dddddd',
  intermediateSize: 0.2,
  showAxisLabels:          true,
...
function getOverviewOptions(opts) {
  ...
  const optNames = [
    ...
    'axisLabelColor',
    'intermediateMajorGridlineColor',
    'intermediateMinorGridlineColor',
    'intermediateSize',
    'formatAxisTime',
    'fontFamily',
    'fontSize',
